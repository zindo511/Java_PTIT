...
public class J05041 {
    static class Sheet {
        ...
        public String toString() {
            return "NV" + ma + " " + ten + " " + luongThang + " " + thuong + " " + phuCap + " " + thucLinh;
        }
    }
    public static void main(String[] args) {
        ...
        for (int i = 0; i < sheets.size(); ++i) {
            ...
            sheet.luongThang = luongThang;
            sheet.thuong = thuong;
            sheet.phuCap = phuCap;
            sheet.thucLinh = thucLinh;
        }
        sheets.sort(
                Comparator.comparing((Sheet sheet) -> sheet.thucLinh, Comparator.reverseOrder())
        );
