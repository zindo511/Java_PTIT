...
public class J05051 {
    static class Money {
        String ma, loai;
        int cu, moi;
        long tongTien, thanhTien, phuTroi, heSo;
        ...
        public String toString() {
            return "KH" + ma + " " + heSo + " " + thanhTien + " " + phuTroi + " " + tongTien;
        }
    }
...
//            long phuTroNew = Math.round(phuTroi);
            ...
            money.tongTien = tongTien;
            money.heSo = heSo;
            money.thanhTien = thanhTien;
            money.phuTroi = phuTro;
        }
        monies.sort(
                Comparator.comparing((Money money) -> money.tongTien, Comparator.reverseOrder())
        );
