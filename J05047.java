...
public class J05047 {
    ...
    static class Sheet {
        String ma, ten;
        int tienChietKhau, thanhTien;

        public Sheet(String ma, String ten, int tienChietKhau, int thanhTien) {
            this.ma = ma;
            this.ten = ten;
    ...
    public static void main(String[] args) {
        ...
        while (t-- > 0) {
            ...
            sheets.add(new Sheet(code + "0" + String.valueOf(countMap.get(code)), ten, tienChietKhau, thanhTien));
        }

        sheets.sort(
                Comparator.comparing((Sheet sheet) -> sheet.tienChietKhau, Comparator.reverseOrder())
        );
